...
├── commands/           # Cursor slash commands (copy to .cursor-and-claude/commands to use)
...
### ⚡ [Commands](./commands/)
Cursor slash commands. Type `/` in Cursor chat to use. Copy to `.cursor-and-claude/commands/` or symlink:
