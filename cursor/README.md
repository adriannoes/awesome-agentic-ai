...
To check for updates, run from the repo root:
```bash
...
- Reusable agent skills (e.g. create-rule, create-skill, update-settings)
- Place shared skills here so one definition works in both tools
