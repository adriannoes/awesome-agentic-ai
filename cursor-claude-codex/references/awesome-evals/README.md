...
- **`papers/reliability-and-reasoning/`** ([../../papers/reliability-and-reasoning/](../../papers/reliability-and-reasoning/)) — judge/eval reliability papers, including [Judging LLM-as-a-Judge with MT-Bench and Chatbot Arena](../../papers/reliability-and-reasoning/Judging%20LLM-as-a-Judge%20with%20MT-Bench%20and%20Chatbot%20Arena.pdf) (foundational MT-Bench/Arena study), [RoPoLL](../../papers/reliability-and-reasoning/RoPoLL_Robust_Panel_of_LLM_Judges.pdf) (robust PoLL aggregation), and BinEval; pairs with README §8 (LLM-as-judge & verifiers) and PATTERNS §1
- **`papers/agents-and-engineering/`** ([../../papers/agents-and-engineering/](../../papers/agents-and-engineering/)) — the README's §3 (harness), §9 (code evals), and §10 (safety) cite the same paper canon (SWE-bench, τ-bench, AgentDojo, …); includes [ReAct](../../papers/agents-and-engineering/REACT-%20SYNERGIZING%20REASONING%20AND%20ACTING%20IN%20LANGUAGE%20MODELS.pdf); `notes/papers/` deepens those
