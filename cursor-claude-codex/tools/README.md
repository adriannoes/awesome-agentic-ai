...
CLI utilities that complement agent skills — setup, environment isolation, and workflow helpers. These are **not** `SKILL.md` bundles; install or run them like any other dev tool.
